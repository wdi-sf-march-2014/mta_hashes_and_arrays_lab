...
#puts find_distance("N","28th", "23rd")
#puts find_distance("L","1st", "6th")
#puts distance_different_lines("L","N", "1st", "28th")
#puts distance_different_lines("N","S", "8th", "gc")
#puts distance_different_lines("N","S", "ts", "ap")
 
#puts subway_system["N"][2]
#puts find_distance(["a","b","c","d"],"a","c")
#puts find_distance(subway_system["N"],subway_system["N"][0], subway_system["N"][3])
