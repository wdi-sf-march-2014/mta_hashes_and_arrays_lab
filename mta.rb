...
puts "Your trip length is #{n_line_stops + l_line_stops}"
...
n_line_stops = (starting_value - 4).abs
s_line_stops = (ending_value - 4).abs
puts "Your trip length is #{n_line_stops + s_line_stops}"
...
# on L, off at S 
	...
	starting_value =  mta["L"].index(stop_start)
	ending_value = mta["S"].index(stop_end)
	l_line_stops = (starting_value - 2).abs
	s_line_stops = (ending_value - 4).abs
	puts "Your trip length is #{l_line_stops + s_line_stops}"
...
# on L, off at N
	...
	ending_value = mta["N"].index(stop_end)
	l_line_stops = (starting_value - 2).abs
	n_line_stops = (ending_value - 4).abs
	puts "Your trip length is #{l_line_stops + n_line_stops}"
...
# on S, off at N
	...
	n_line_stops = (ending_value - 4).abs
	puts "Your trip length is #{s_line_stops + n_line_stops}"
...
# on S, off at L
	...
	s_line_stops = (starting_value - 4).abs
	l_line_stops = (ending_value - 2).abs
	puts "Your trip length is #{s_line_stops + l_line_stops}"
