...
stops_traveled = (mta[start_train].index(start_station) -
 (mta[start_train].index("Union Square"))).abs + (mta[end_train].index(end_station) -
  mta[end_train].index("Union Square")).abs
